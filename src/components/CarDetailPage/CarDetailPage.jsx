            ...
            <div className="car-detail__sidebar-card">
              ...
              <div className="car-detail__sidebar-socials">
                ...
                <div className="car-detail__sidebar-socials-icons">
                  <a href="https://t.me/Titanium_Raif_RF" target="_blank" rel="noopener noreferrer" className="car-detail__sidebar-social" aria-label="Telegram">
                  ...
                  <a href="https://max.ru/u/f9LHodD0cOLnHLfdFye_Ww3XqqYbzr7mxawADNuEUQr2TpDUzN1K1dusnkc" target="_blank" rel="noopener noreferrer" className="car-detail__sidebar-social car-detail__sidebar-social--max" aria-label="MAX">
                    <img src="/icons/max.webp" alt="MAX" width="36" height="36" />
                  </a>
                </div>
              </div>
            </div>
