...
export default function CarDetailPage({ onAuthOpen }) {
  ...
  const [openSections, setOpenSections] = useState({ appearance: true, specs: false, equipment: false, condition: false, description: false });
                    ...
                    <div className="car-detail__specs-col">
                      ...
                      {(specs.fuel || specs.engine) && (
                        <div className="car-detail__specs-group">
                          ...
                          {specs.fuel && <div className="car-detail__specs-row"><span>Тип двигателя</span><span>{specs.fuel}</span></div>}
                          {specs.engine && <div className="car-detail__specs-row"><span>Объём двигателя</span><span>{specs.engine}</span></div>}
                          {specs.power && <div className="car-detail__specs-row"><span>Максимальная мощность</span><span>{specs.power}</span></div>}
                        </div>
                      )}
                    ...
                    <div className="car-detail__specs-col">
                      ...
                      {car.color.name && (
                        <div className="car-detail__specs-group">
                          ...
                          <div className="car-detail__specs-row"><span>Цвет</span><span>{car.color.name}</span></div>
                        </div>
                      )}
            ...
            <div className="car-detail__section" id="detail-section-condition">
              ...
              {openSections.condition && (
                <div className="car-detail__section-body">
                  ...
                  <div className="car-detail__detail-row">
                    <span className="car-detail__detail-label">Дата публикации</span>
                    <span className="car-detail__detail-value">{car.date}</span>
                  </div>
                </div>
              )}
            </div>
      ...
      {phoneModalOpen && (
        <div className="buy-modal-overlay" onClick={() => setPhoneModalOpen(false)}>
          <div className="buy-modal" onClick={e => e.stopPropagation()}>
            ...
            <a href="tel:+79820780996" className="buy-modal__phone-link">+7 (982) 078-09-96</a>
          </div>
        </div>
      )}
