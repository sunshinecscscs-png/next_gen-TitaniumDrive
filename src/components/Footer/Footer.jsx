  ...
  return (
    <footer className="footer">
      <div className="footer__inner">
        <div className="footer__col footer__col--brand">
          ...
          <div className="footer__socials">
            <a href="https://t.me/Titanium_Raif_RF" target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="Telegram">
            ...
            <a href="https://max.ru/u/f9LHodD0cOLnHLfdFye_Ww3XqqYbzr7mxawADNuEUQr2TpDUzN1K1dusnkc" target="_blank" rel="noopener noreferrer" className="footer__social footer__social--max" aria-label="MAX">
        ...
        <div className="footer__col">
          ...
          <a href="mailto:contact.amv.invest@gmail.com" className="footer__link">contact.amv.invest@gmail.com</a>
          <p className="footer__address">214012, Смоленская область, г. Смоленск, Ново-Ленинградская ул., д. 16, офис 6.1</p>
        </div>
      ...
      <div className="footer__bottom">
        <p className="footer__requisites">ОГРН 1216700022670 &nbsp;·&nbsp; ИНН 6732222250 &nbsp;·&nbsp; КПП 673201001 &nbsp;·&nbsp; ОКПО 48038532 &nbsp;·&nbsp; ОКАТО 66401000000 &nbsp;·&nbsp; ОКТМО 66701000001</p>
      </div>
    </footer>
  );
}
